...
% 2
	d_3 = a_3 - Y(t,:)';
% 3
	d_2 = (Theta2'*d_3).*sigmoidGradient([1;z_2]); %should this not be a_2?
% 4
...
Theta1_grad = Theta1_grad + lambda*ans/m;

[zeros(size(Theta2,1),1) Theta2(:,2:end)];
Theta2_grad = Theta2_grad + lambda*ans/m;
