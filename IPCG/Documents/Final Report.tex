...
\item[Borderlands] A commercially successful videogame, Borderlands was one of the first modern games to extensively use and publicise a PCG system; in this instance to generate millions of different varied weapons \cite{borderlandsguns} - a selling point for the game. 
\end{description}
