...
\begin{tabular}{ll}
/bin & GameApplet, java.policy.applet, Parser\\
/bin/Core & Core classes: Controller, Evaluator, Generator, Model, View\\
/bin/Model & ActivePart, CollisionTestHarness, Component, Constants\\
/bin/Model & FinalComponent, FinalPlatformPart, FlatComponent\\
/bin/Model & FlatPlatformPart, GameCollection, GameObject, GapComponent\\
/bin/Model & GapPart, GapRatingTestHarness, Level, ObstacleComponent\\
/bin/Model & ObstaclePart, Part, Pattern, Player, SimplePattern, SinglePattern\\
/bin/UI & ConfirmPanel, FeedbackPanel, GameWindow, QuestionnairePanel\\
/bin/UI & Screen, TextPanel\\
/bin/Web & \\
/data & 1335693754.txt, 1335696208.txt, 1335707945.txt, 1335708270.txt\\
/data & 1335708900.txt, 1335709874.txt, 1335710086.txt, 1335710724.txt\\
/data & 1335720808.txt, 1335730090.txt, 1335730651.txt, 1335730978.txt\\
/data & 1335735408.txt, 1335735963.txt, 1335736558.txt, 1335736715.txt\\
/data & 1335739370.txt, 1335739494.txt, 1335741014.txt, 1335771670.txt\\
/data & 1335783028.txt, 1335783750.txt, 1335802212.txt, 1335809793.txt\\
/data & 1335812551.txt, 1335815038.txt, 1335815317.txt, output.txt\\
/Documents & done.pdf, Final Report.pdf, Final Report.tex, If.tex\\
/Documents & Interim Report.pdf, Interim Report.tex, IPCG.bib\\
/Documents & Project Brief.pdf, Project Brief.tex, Stripped Interim Report.pdf\\
/Documents & system.pdf, system2.pdf, todo.png\\
/src & GameApplet.java, Parser.java\\
/src/Core & Controller.java, Evaluator.java, Generator.java, Model.java, View.java\\
/src/Model & ActivePart.java, CollisionTestHarness.java, Component.java\\
/src/Model & Constants.java, FinalComponent.java, FinalPlatformPart.java\\
/src/Model & FlatComponent.java, FlatPlatformPart.java, GameCollection.java\\
/src/Model & GameObject.java, GapComponent.java, GapPart.java\\
/src/Model & Level.java, ObstacleComponent.java, ObstaclePart.java, Part.java\\
/src/Model & Pattern.java, Player.java, SimplePattern.java, SinglePattern.java\\
/src/UI & ConfirmPanel.java, FeedbackPanel.java, GameWindow.java\\
/src/UI & QuestionnairePanel.java, Screen.java, TextPanel.java\\
/src/Web & 3YP.html, basic.css, fallback.html, favicon.png, form.php, index.php\\
/src/Web & info.php, IPCG-web.jar, java.php, java.policy.applet, submit.php\\
\end{tabular}
